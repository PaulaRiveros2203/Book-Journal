...
## Login
![captura de pantalla login](Imagenes-README/Login.png)
...
## Registro
![captura de pantalla registo](Imagenes-README/Registro.png)
...
## Perfil
![Captura de pantalla perfil](Imagenes-README/Perfil.png)
...
## Editar Peril
![Captura de pantalla editar el perfil](Imagenes-README/Edit_perfil.png)
...
## Lista Deseos
![Captura de pantalla lista libros deseados](Imagenes-README/Lista_deseos.png)
...
## Lectura Actual
![Captura de pantalla lectura actual](Imagenes-README/Lectura_actual.png)
...
## Libros Leidos
![Captura de pantalla lista de libros leidos](Imagenes-README/Libros_leidos.png)
...
![Captura de pantalla navbar](Imagenes-README/Navbar.png)
![Captura de menu desplegable ](Imagenes-README/Menu_desplegable.png)


## Títulos y Tipografías
![Captura de titulo y tipografia](Imagenes-README/Titulos_tipografia.png)  

## Inputs y Formularios
![Captura de pantalla input en formularios](Imagenes-README/Formularios.png)

## Botones
![Captura de pantalla botones](Imagenes-README/Botones.png)

## Cards de Libros e Historial
![Captura de pantalla cards de los libros e historial](Imagenes-README/Tarjetas_libros.png)

## Sistema de Estrellas
![Captura de pantalla sistema de estrellas calificacion](Imagenes-README/Sistema_estrellas.png)

## Perfil e Imágenes Laterales
![Captura de pantalla Perfil y hojas de corativas](Imagenes-README/Perfil-hojasdecorativas.png)
